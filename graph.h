...
public:
	...
	index_t get_node_num() { return node_num; }
	index_t get_arc_num() { return static_cast<index_t>(arc_last - arcs); }
...
//    mxAssert(node_last + num <= node_max, "Failed to predict num of nodes!");
...
//    mxAssert(arc_last < arc_max, "Failed to predict num of arcs!"); // do not allow for re-alloc!
